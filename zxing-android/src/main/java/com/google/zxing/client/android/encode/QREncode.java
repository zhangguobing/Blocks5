...
public final class QREncode {
     ...
     * @return
     */
    public static Bitmap encodeQR(QRCodeEncoder2 codeEncoder) {
     ...
     * @return
     */
    public static Bitmap encodeQRWithoutWhite(QRCodeEncoder2 codeEncoder) {
        // This assumes the view is full screen, which is a good assumption
        Context context = codeEncoder.getContext();
        int smallerDimension = getSmallerDimension(context.getApplicationContext());
        try {
            return codeEncoder.encodeAsBitmapWithoutWhite(smallerDimension);
        } catch (WriterException e) {
            e.printStackTrace();
        }
        return null;
    ...
    private static int getSmallerDimension(Context context) {
        ...
        smallerDimension = smallerDimension * 6 / 10;
    ...
    public static class Builder {
        ...
        public QRCodeEncoder2 build() {
            ...
            return new QRCodeEncoder2(this, context.getApplicationContext());
        }
    }
}

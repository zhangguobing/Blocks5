...
public class CustomConverterFactory extends Converter.Factory  {
    ...
    /**
     * Create an instance using {@code retrofit2.converter.gson} for conversion. Encoding to JSON and
     * decoding from JSON (when no charset is specified by a header) will use UTF-8.
     */
    ...
    private CustomConverterFactory(Gson gson) {
        if (gson == null) throw new NullPointerException("retrofit2.converter.gson == null");
        this.gson = gson;
    }

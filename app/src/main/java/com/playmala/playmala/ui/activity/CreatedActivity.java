...
import com.playmala.playmala.ui.activity.fragment.CreatorActivityListFragment;
...
public class CreatedActivity extends BaseActivity{
    ...
    private void initTabs(){
        ...
        fragments.add(CreatorActivityListFragment.newInstance("0,1",user_id));
        fragments.add(CreatorActivityListFragment.newInstance("2",user_id));
        fragments.add(CreatorActivityListFragment.newInstance("3,4,5,6,7",user_id));

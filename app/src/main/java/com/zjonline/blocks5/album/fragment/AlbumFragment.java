 ...
 */
package com.zjonline.blocks5.album.fragment;
...
import com.zjonline.blocks5.album.AlbumWrapper;
import com.zjonline.blocks5.album.UIWrapper;
import com.zjonline.blocks5.album.adapter.AlbumImageAdapter;
import com.zjonline.blocks5.album.base.NoFragment;
import com.zjonline.blocks5.album.dialog.AlbumFolderDialog;
import com.zjonline.blocks5.album.entity.AlbumFolder;
import com.zjonline.blocks5.album.entity.AlbumImage;
import com.zjonline.blocks5.album.impl.AlbumCallback;
import com.zjonline.blocks5.album.impl.OnCompatItemClickListener;
import com.zjonline.blocks5.album.impl.OnCompoundItemCheckListener;
import com.zjonline.blocks5.album.task.ScanTask;
import com.zjonline.blocks5.album.util.DisplayUtils;
import com.zjonline.blocks5.album.widget.recyclerview.AlbumVerticalGirdDecoration;
...
public class AlbumFragment extends BasicCameraFragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mTitle = argument.getString(AlbumWrapper.KEY_INPUT_TITLE);
        if (TextUtils.isEmpty(mTitle)) mTitle = getString(R.string.album_title);

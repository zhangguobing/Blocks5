package com.bing.blocks5.widget.bottomsharedialog;
...
//    public BottomShareDialog title(String title) {
//        customDialog.title(title);
//        return this;
//    }
//
//    public BottomShareDialog title(int title) {
//        customDialog.title(title);
//        return this;
//    }

    public BottomShareDialog background(int res) {
        customDialog.background(res);
        return this;
    }

    public BottomShareDialog inflateMenu(int menu, OnItemClickListener onItemClickListener) {
        customDialog.inflateMenu(menu, onItemClickListener);
        return this;
    }

    public BottomShareDialog layout(int layout) {
        customDialog.layout(layout);
        return this;
    }

    public BottomShareDialog orientation(int orientation) {
        customDialog.orientation(orientation);
        return this;
    }

    public BottomShareDialog addItems(List<Item> items, OnItemClickListener onItemClickListener) {
     ...
     * @deprecated
     */
    public BottomShareDialog itemClick(OnItemClickListener listener) {
...
//        private TextView titleView;
        ...
        private void init() {
            padding = getContext().getResources().getDimensionPixelSize(R.dimen.bottom_dialog_padding);
            topPadding = getContext().getResources().getDimensionPixelSize(R.dimen.bottom_dialog_top_padding);
            leftPadding = getContext().getResources().getDimensionPixelSize(R.dimen.bottom_dialog_padding);
...
//            titleView = (TextView) findViewById(R.id.title);
        ...
        void addItems(List<Item> items, OnItemClickListener onItemClickListener) {
            ...
            if (layout == LINEAR)
                ...
                manager = new GridLayoutManager(getContext(), 4, orientation, false);
        ...
        private class DialogAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
            ...
            class TopHolder extends RecyclerView.ViewHolder {
                ...
                TopHolder(View view) {
                    ...
                    item.setTextColor(ContextCompat.getColor(view.getContext(), R.color.primary_text));
                    item.setTextSize(TypedValue.COMPLEX_UNIT_PX, getContext().getResources().getDimension(R.dimen.bottom_dialog_small_font_size));
            ...
            class LeftHolder extends RecyclerView.ViewHolder {
                ...
                LeftHolder(View view) {
                    ...
                    item.setTextSize(TypedValue.COMPLEX_UNIT_PX, getContext().getResources().getDimension(R.dimen.bottom_dialog_small_normal_size));
